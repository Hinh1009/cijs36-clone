...
<header style="height:80px;">
    <nav class="header-nav" id="header-nav">
        ...
        <div class="nav-right-side">
            ...
            <div class="nav-detail">
                <i id = "user"class="fas fa-user" style="font-size: 25px;"></i>
            </div>
    ...
    <div class="nav-responsive">
        ...
        <div class="nav-responsive-detail"><span >Giới thiệu</span></div>
        <div class="nav-responsive-detail"><span >Phòng</span></div>
        <div class="nav-responsive-deatil"><span>Liên hệ</span></div>
        <div class="nav-responsive-deatil"><span><i class="fas fa-phone-alt" style="margin-right: 15px;"></i>0796 922 0162</span></div>
        <div class="nav-responsive-deatil"><button>Đặt phòng</button></div>
        <div class="nav-responsive-deatil"><span><i id="user1" class="fas fa-user"  style="font-size: 25px;"></i></span></div>
    </div>
</header>
`
components.main = ` 
...
<main class="main-trang-chu">
    ...
    <section class="main-section-2">
        ...
        <div class="main-section-2-content">
            <div>Khách sạn Mona là một nhà nghỉ khách sạn được thành lập vào năm 2017 với 26 phòng có kích cỡ khách nhau phù hợp với nhiều nhu cầu của khách hàng. Hệ thống thiết bị hiện đại, điều hòa, tivi, bàn ghế được làm từ gỗ, sóng wifi và các
                các dịch vụ đưa đón khách tham quan các điểm du lịch. Được thiết kế và trang trí theo phong cách Mona rất sang trọng và quý phái. Các trang thiết bị và phòng ốc của nhà nghỉ – khách sạn rất tiện nghi và hiện đại nhằm mang lại sự
                hài lòng và thoải mái cho khách hàng trong suốt thời gian lưu trú tại phòng khách sạn.</div>
            <div>Khách sạn Mona là một nhà nghỉ khách sạn được thành lập vào năm 2017 với 26 phòng có kích cỡ khách nhau phù hợp với nhiều nhu cầu của khách hàng. Hệ thống thiết bị hiện đại, điều hòa, tivi, bàn ghế được làm từ gỗ, sóng wifi và các
                các dịch vụ đưa đón khách tham quan các điểm du lịch. Được thiết kế và trang trí theo phong cách Mona rất sang trọng và quý phái. Các trang thiết bị và phòng ốc của nhà nghỉ – khách sạn rất tiện nghi và hiện đại nhằm mang lại sự
                hài lòng và thoải mái cho khách hàng trong suốt thời gian lưu trú tại phòng khách sạn.</div>
        </div>
